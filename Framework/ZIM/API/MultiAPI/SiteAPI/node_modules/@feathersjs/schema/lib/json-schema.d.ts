 ...
 */
export declare const queryProperty: <T extends import("json-schema-to-ts/lib/types/definitions").JSONSchema7, X extends {
    [key: string]: import("json-schema-to-ts/lib/types/definitions").JSONSchema7;
}>(def: T, extensions?: X) => {
